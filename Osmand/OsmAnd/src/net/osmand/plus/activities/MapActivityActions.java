...
public class MapActivityActions implements DialogProvider {
	...
	private ContextMenuAdapter createOptionsMenu() {
		...
		************************************************************************************************************************/
		...
		//17301591 is the icon used here. It's also know as  "ic_menu_view" icon.
		
		optionsMenuHelper.registerItem(R.string.MessiahMenu, 17301591, 
				new OnContextMenuClick() {
					...
					public void onContextMenuClick(int itemId, int pos,
						...
						.setIcon(17301591)
					    .setTitle("Messiah Plugin Help")
					    .setMessage(R.string.MessiahHelp)
