...
import com.subhadeep.Messiah.MessiahControllerService;
...
public class OsmandApplication extends Application implements ClientContext {
	...
	*************************************************************************************************************************
	...
	Start of Modification 1/X
	
	*************************************************************************************************************************
	*************************************************************************************************************************
	************************************************************************************************************************/
	
	Intent service_messiah = null;
	
	/************************************************************************************************************************
	*************************************************************************************************************************
	*************************************************************************************************************************
	
	End of Modification 1/X
...
//		}
	...
	public synchronized void closeApplication(final Activity activity) {
		...
		************************************************************************************************************************/
		...
		if(service_messiah != null)
		{
			stopService(service_messiah);
			service_messiah = null;
		}
		osmandSettings.MESSIAH_ON.set(false);
		osmandSettings.IS_POLICE.set(false);
		osmandSettings.SOS.set(false);
		Log.e("MESSIAH MONITOR","STOPPED");
	...
	public synchronized void startApplication() {
		...
		************************************************************************************************************************/
		...
		if(service_messiah == null){
			service_messiah = new Intent(this, MessiahControllerService.class);
			startService(service_messiah);
			Log.e("MESSIAH MONITOR","STARTED");
		}
	...
	public void showShortToastMessage(String str) {
		AccessibleToast.makeText(this, str, Toast.LENGTH_SHORT).show();
	}
